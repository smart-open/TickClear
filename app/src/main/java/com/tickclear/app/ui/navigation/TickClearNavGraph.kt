...
@Composable
fun TickClearApp(rootViewModel: RootViewModel = hiltViewModel()) {
...
private fun AppNavHost(
    ...
    NavHost(
        ...
        composable(Routes.TASKS) { TasksScreen(isWide = isWide, onNavigateToRecycleBin = { navController.navigate(Routes.RECYCLE_BIN) }) }
